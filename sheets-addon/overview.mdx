...
## **Privacy Policy**
Critique AI does not share your search queries. **Users must not share their API key** or embed it in shared Google Sheets. Google Workspace APIs themselves are not used to develop, improve, or train generalized AI and/or ML models.

### **Data Handling**
- Queries are **processed in real-time** and returned to the user, Information supplied by the user may stored securely in our database, but it will never be shared or otherwised distributed to third parties.
