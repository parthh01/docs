...
## **Privacy Policy**
Critique AI does not share your search queries. **Users must not share their API key** or embed it in shared Google Sheets. Google Workspace APIs themselves are not used to develop, improve, or train generalized AI and/or ML models. However, we may use the search query information as training data to improve our models, this data will be stored securely and will never be shared or otherwise distributed to third parties. 
Critique AI does not access or store any other data from your Google Sheets, except the values you provide in the search query. The contents of your google sheets will never be used for training or improving our models, except when explicitly provided by the user in the search query.
