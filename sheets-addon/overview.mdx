...
## **Privacy Policy**
Critique AI does not share your search queries. **Users must not share their API key** or embed it in shared Google Sheets. Google Workspace APIs themselves are not used to develop, improve, or train generalized AI and/or ML models. However, we may use the data you provide as input to improve our models, this data will be stored securely and will never be shared or otherwise distributed to third parties.
