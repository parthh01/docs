...
- Query results, including tables, graphs, and internet search results, may be temporarily cached for performance optimization but do not persist beyond the current session, and are not stored permanently in any way.
...
- No persistent storage of query results beyond temporary processing needs.
- Users have the right to request deletion of any stored information related to their account.
- No actual data from your database is stored by Critique DB. 
